      ...
      child: Column(
        children: [
          Text('Please enter the OTP sent\non your registered phone number.',
            style: TextStyle(
              letterSpacing: 1.50,color: Colors.white70,
              fontSize:16,),
          ),
        ],
      ),
      ...
      child: Offstage(
        ...
        child: Row(
          ...
          children: <Widget>[
            ...
            OtpTimer(_controller, 15.0, Color(0xFF021636))
          ],
        ),
      ),
    );
  ...
  get _getResendButton {
    return Container(
      ...
      child: MaterialButton(
          ...
          color: Color(0xFF021636),
          onPressed: () {
            // Resend you OTP via API or anything
            clearOtp();
            _startCountdown();
          },
          child: Text("Resend",style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white,letterSpacing: 1.4),
          )
      ),
    );
  }
