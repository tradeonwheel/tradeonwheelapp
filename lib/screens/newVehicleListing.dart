...
class NewVehicleListing extends StatefulWidget {
  final Vehicle vehicle;
  final Function press;
  const NewVehicleListing({
    Key key,
    this.vehicle,
    this.press,
  }) : super(key: key);
  @override
  _NewVehicleListingState createState() => _NewVehicleListingState();
}

class _NewVehicleListingState extends State<NewVehicleListing> {
